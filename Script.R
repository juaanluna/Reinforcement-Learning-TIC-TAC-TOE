jogotictac <- function(jogada)
{
  ...
  verificavitoria = function()
  {
    ...
    #horizontais
    if ( 
      (substr(decvit,1,3) %in% c("XXX"))   | ( substr(decvit,3,6) %in% c("XXX"))   | (substr(decvit,7,9) %in% c("XXX")) | 
      (paste(substr(decvit,1,1),substr(decvit,4,4),substr(decvit,7,7),sep="") %in% c("XXX")) |   # verticais
      (paste(substr(decvit,2,2),substr(decvit,5,5),substr(decvit,8,8),sep="") %in% c("XXX")) |
      (paste(substr(decvit,3,3),substr(decvit,6,6),substr(decvit,9,9),sep="") %in% c("XXX")) |
      (paste(substr(decvit,1,1),substr(decvit,5,5),substr(decvit,9,9),sep="") %in% c("XXX")) |  #transver
      (paste(substr(decvit,7,7),substr(decvit,5,5),substr(decvit,3,3),sep="") %in% c("XXX")) 
    )   warning("julia wins!")
    
    if ( 
      (substr(decvit,1,3) %in% c("BBB"))   | ( substr(decvit,3,6) %in% c("BBB"))   | (substr(decvit,7,9) %in% c("BBB")) | 
      (paste(substr(decvit,1,1),substr(decvit,4,4),substr(decvit,7,7),sep="") %in% c("BBB")) |   # verticais
      (paste(substr(decvit,2,2),substr(decvit,5,5),substr(decvit,8,8),sep="") %in% c("BBB")) |
      (paste(substr(decvit,3,3),substr(decvit,6,6),substr(decvit,9,9),sep="") %in% c("BBB")) |
      (paste(substr(decvit,1,1),substr(decvit,5,5),substr(decvit,9,9),sep="") %in% c("BBB")) |  #transver
      (paste(substr(decvit,7,7),substr(decvit,5,5),substr(decvit,3,3),sep="") %in% c("BBB")) 
    )   warning("Voce wins!")
